...
import com.example.android.models.RegisterUserRequest  // ✅ Use correct data model
...
class RegisterPart2 : AppCompatActivity() {
    ...
    private fun registerUser(phone: String, barangay: String, municipality: String, country: String, province: String, postalCode: String) {
        ...
        val userDetails = RegisterUserRequest(phone, barangay, municipality, country, province, postalCode)  // ✅ FIXED
